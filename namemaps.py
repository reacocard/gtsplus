...
# this is roughly f(x) = 254*x/100, rounded up when x > 128 and down
# when x < 128. but the table is easier.
genderthreshholds = {
    0:    0,
    12.5: 31,
    25:   63,
...
# 0         ability 1
# 1         ability 2
# 2         dreamworld ability
# 3         alternate forme ability
species_abilities = {
        ...
        105: ('Rock Head', 'Lightningrod', 'Battle Armor'),
        ...
        430: ('Insomnia', 'Super Luck', 'Prankster'),
        200: ('Levitate', '', ''),
        429: ('Levitate', '', ''),
        201: ('Levitate', '', ''),
        ...
        243: ('Pressure', '', 'Volt Absorb'),
        244: ('Pressure', '', 'Flash Fire'),
        245: ('Pressure', '', 'Water Absorb'),
        246: ('Guts', '', 'Sand Veil'),
        247: ('Shed Skin', '', ''),
        ...
        276: ('Guts', '', 'Scrappy'),
        277: ('Guts', '', 'Scrappy'),
        278: ('Keen Eye', '', 'Rain Dish'),
        279: ('Keen Eye', '', 'Rain Dish'),
        ...
        349: ('Swift Swim', '', 'Adaptability'),
        350: ('Marvel Scale', '', 'Cute Charm'),
        351: ('Forecast', '', ''),
        352: ('Color Change', '', ''),
        ...
        524: ('Sturdy', '', 'Sand Force'),
        525: ('Sturdy', '', 'Sand Force'),
        526: ('Sturdy', '', 'Sand Force'),
        ...
        543: ('Poison Point', 'Swarm', 'Quick Feet'),
        544: ('Poison Point', 'Swarm', 'Quick Feet'),
        545: ('Poison Point', 'Swarm', 'Quick Feet'),
        ...
        574: ('Frisk', '', 'Shadow Tag'),
        575: ('Frisk', '', 'Shadow Tag'),
        576: ('Frisk', '', 'Shadow Tag'),
        ...
        582: ('Ice Body', '', 'Weak Armor'),
        583: ('Ice Body', '', 'Weak Armor'),
        584: ('Ice Body', '', 'Weak Armor'),
        ...
        607: ('Flash Fire', 'Flame Body', 'Shadow Tag'),
        608: ('Flash Fire', 'Flame Body', 'Shadow Tag'),
        609: ('Flash Fire', 'Flame Body', 'Shadow Tag'),
        610: ('Rivalry', 'Mold Breaker', 'Unnerve'),
        611: ('Rivalry', 'Mold Breaker', 'Unnerve'),
        612: ('Rivalry', 'Mold Breaker', 'Unnerve'),
        613: ('Snow Cloak', '', 'Rattled'),
        614: ('Snow Cloak', '', 'Swift Swim'),
        615: ('Levitate', '', ''),
